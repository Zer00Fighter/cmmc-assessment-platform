...
Sprint 19.12 adds a Type I/Type II-aware Word deliverable and an automated
acceptance gate for the complete SOC 2 workflow.

## Deliverable boundary

The generated document is titled **SOC 2 Readiness and Assessment Report**. It
documents Omni assessment work and explicitly states that it is not an AICPA
...
- exceptions and related corrective actions; and
...
- service commitments and system-boundary binding;
